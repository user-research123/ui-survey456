...
if '现价' in df.columns and '商品' in df.columns:
    ...
    for title in titles:
        ...
        # 充值/代充
        elif any(keyword in title_lower for keyword in ['代充', '充值', '月卡', '通行证', '有偿钻', '首充', '折扣号']):
        ...
        # 安装包/资源文件
        elif any(keyword in title_lower for keyword in ['安装包', 'mod', '材质包', '角色卡', '壁纸', '素材', 'cg鉴赏', '录屏', '人物卡', '补丁', '存档', 'hud包']):
            categories.append('游戏资源/安装包')
        # PC单机游戏/Steam游戏
        elif any(keyword in title_lower for keyword in ['steam', 'pc单机', 'cdk', '正版激活码', 'wrc', '东方铁红', '环世界', '雨世界', '神舞幻想', '锻造屋的物语', 'tnt冒险之旅', '彩虹物语', '天逆沉默传奇', '太古神王', '粘粘世界', 'mugen', '无尽世界的危机']):
    ...
    output_path = '/Users/jiewen/.real/users/user-777da3823a68e71779b041c8e7807df0/workspace/xianyu_analysis_4_1_final.xlsx'
